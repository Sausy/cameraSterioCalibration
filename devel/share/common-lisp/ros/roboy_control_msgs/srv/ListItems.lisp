...
(cl:defmethod cl:initialize-instance :after ((m <ListItems-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListItems-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-srv:<ListItems-request> is deprecated: use roboy_control_msgs-srv:ListItems-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <ListItems-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_control_msgs-srv:name-val is deprecated.  Use roboy_control_msgs-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ListItems-request>)))
  ...
  "roboy_control_msgs/ListItemsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ListItems-request)))
  "Returns string type for a service object of type 'ListItems-request"
  "roboy_control_msgs/ListItemsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ListItems-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListItems-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_control_msgs-srv:<ListItems-response> is deprecated: use roboy_control_msgs-srv:ListItems-response instead.")))

(cl:ensure-generic-function 'items-val :lambda-list '(m))
(cl:defmethod items-val ((m <ListItems-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_control_msgs-srv:items-val is deprecated.  Use roboy_control_msgs-srv:items instead.")
  (items m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ListItems-response>)))
  ...
  "roboy_control_msgs/ListItemsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ListItems-response)))
  "Returns string type for a service object of type 'ListItems-response"
  "roboy_control_msgs/ListItemsResponse")
