...
(cl:defmethod cl:initialize-instance :after ((m <FindObject-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindObject-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<FindObject-request> is deprecated: use roboy_cognition_msgs-srv:FindObject-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <FindObject-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:type-val is deprecated.  Use roboy_cognition_msgs-srv:type instead.")
  (type m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FindObject-request>)))
  ...
  "roboy_cognition_msgs/FindObjectRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindObject-request)))
  "Returns string type for a service object of type 'FindObject-request"
  "roboy_cognition_msgs/FindObjectRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FindObject-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindObject-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboy_cognition_msgs-srv:<FindObject-response> is deprecated: use roboy_cognition_msgs-srv:FindObject-response instead.")))

(cl:ensure-generic-function 'found-val :lambda-list '(m))
(cl:defmethod found-val ((m <FindObject-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:found-val is deprecated.  Use roboy_cognition_msgs-srv:found instead.")
  (found m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <FindObject-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:x-val is deprecated.  Use roboy_cognition_msgs-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <FindObject-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:y-val is deprecated.  Use roboy_cognition_msgs-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <FindObject-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboy_cognition_msgs-srv:z-val is deprecated.  Use roboy_cognition_msgs-srv:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FindObject-response>)))
  ...
  "roboy_cognition_msgs/FindObjectResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindObject-response)))
  "Returns string type for a service object of type 'FindObject-response"
  "roboy_cognition_msgs/FindObjectResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindObject)))
  ...
  "roboy_cognition_msgs/FindObject")