...
"""autogenerated by genpy from roboy_cognition_msgs/OrderIceCreamGoal.msg. Do not edit."""
import codecs
import sys
...
class OrderIceCreamGoal(genpy.Message):
  _md5sum = "c1f1cb719f39dc24da6159a391bbf364"
  _type = "roboy_cognition_msgs/OrderIceCreamGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrderIceCreamGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.scoops))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.scoops = s.unpack(str[start:end])
      return self
