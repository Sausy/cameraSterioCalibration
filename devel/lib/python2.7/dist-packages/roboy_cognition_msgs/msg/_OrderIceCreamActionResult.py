...
"""autogenerated by genpy from roboy_cognition_msgs/OrderIceCreamActionResult.msg. Do not edit."""
import codecs
import sys
...
class OrderIceCreamActionResult(genpy.Message):
  _md5sum = "42e39cf8037cd64714ac990d1749897a"
  _type = "roboy_cognition_msgs/OrderIceCreamActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roboy_cognition_msgs/OrderIceCreamResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrderIceCreamActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = roboy_cognition_msgs.msg.OrderIceCreamResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = roboy_cognition_msgs.msg.OrderIceCreamResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.error_message = str[start:end].decode('utf-8', 'rosmsg')
      else:
