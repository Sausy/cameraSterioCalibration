...
"""autogenerated by genpy from roboy_middleware_msgs/EmergencyStopRequest.msg. Do not edit."""
import codecs
import sys
...
class EmergencyStopRequest(genpy.Message):
  _md5sum = "eb76188ba30b943945368157cf534274"
  _type = "roboy_middleware_msgs/EmergencyStopRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool all
int8[] id_list
"""
  __slots__ = ['all','id_list']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.id_list))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.id_list = s.unpack(str[start:end])
      return self
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from roboy_middleware_msgs/EmergencyStopResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class EmergencyStopResponse(genpy.Message):
  ...
  _type = "roboy_middleware_msgs/EmergencyStopResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  __slots__ = ['states']
  _slot_types = ['roboy_middleware_msgs/ControllerState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = roboy_middleware_msgs.msg.ControllerState()
        _x = val1
        start = end
        end += 5
...
class EmergencyStop(object):
  _type          = 'roboy_middleware_msgs/EmergencyStop'
  _md5sum = '769d67555bcace7e21068dd8a08c7e86'
