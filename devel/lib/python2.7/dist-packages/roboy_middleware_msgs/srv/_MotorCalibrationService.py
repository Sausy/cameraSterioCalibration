...
"""autogenerated by genpy from roboy_middleware_msgs/MotorCalibrationServiceRequest.msg. Do not edit."""
import codecs
import sys
...
class MotorCalibrationServiceRequest(genpy.Message):
  _md5sum = "18e91568e8fd33c1b55549344f17ae32"
  _type = "roboy_middleware_msgs/MotorCalibrationServiceRequest"
...
"""
  __slots__ = ['fpga','motor','degree','timeout','number_of_data_points','displacement_min','displacement_max']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       fpga,motor,degree,timeout,number_of_data_points,displacement_min,displacement_max
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_7i().pack(_x.fpga, _x.motor, _x.degree, _x.timeout, _x.number_of_data_points, _x.displacement_min, _x.displacement_max))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.fpga, _x.motor, _x.degree, _x.timeout, _x.number_of_data_points, _x.displacement_min, _x.displacement_max,) = _get_struct_7i().unpack(str[start:end])
      return self
...
def _get_struct_7i():
    ...
    return _struct_7i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from roboy_middleware_msgs/MotorCalibrationServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class MotorCalibrationServiceResponse(genpy.Message):
  ...
  _type = "roboy_middleware_msgs/MotorCalibrationServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.estimated_spring_parameters))
      length = len(self.load)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.load))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.estimated_spring_parameters = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.load = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
...
class MotorCalibrationService(object):
  _type          = 'roboy_middleware_msgs/MotorCalibrationService'
  _md5sum = '892408477819859495b143dca33ce42a'
