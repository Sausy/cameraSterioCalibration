...
"""autogenerated by genpy from roboy_middleware_msgs/JointStatus.msg. Do not edit."""
import codecs
import sys
...
class JointStatus(genpy.Message):
  _md5sum = "4933cd49b716032e0de2cf902e8150fa"
  _type = "roboy_middleware_msgs/JointStatus"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint32[] absAngles
uint32[] relAngles"""
  __slots__ = ['absAngles','relAngles']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.absAngles))
      length = len(self.relAngles)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.relAngles))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.absAngles = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.relAngles = s.unpack(str[start:end])
      return self
