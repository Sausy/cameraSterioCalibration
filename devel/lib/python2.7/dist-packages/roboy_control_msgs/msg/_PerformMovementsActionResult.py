...
"""autogenerated by genpy from roboy_control_msgs/PerformMovementsActionResult.msg. Do not edit."""
import codecs
import sys
...
class PerformMovementsActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "roboy_control_msgs/PerformMovementsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roboy_control_msgs/PerformMovementsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PerformMovementsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = roboy_control_msgs.msg.PerformMovementsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = roboy_control_msgs.msg.PerformMovementsResult()
