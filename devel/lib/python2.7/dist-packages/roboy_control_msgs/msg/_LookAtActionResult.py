...
"""autogenerated by genpy from roboy_control_msgs/LookAtActionResult.msg. Do not edit."""
import codecs
import sys
...
class LookAtActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "roboy_control_msgs/LookAtActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roboy_control_msgs/LookAtResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LookAtActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = roboy_control_msgs.msg.LookAtResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = roboy_control_msgs.msg.LookAtResult()
