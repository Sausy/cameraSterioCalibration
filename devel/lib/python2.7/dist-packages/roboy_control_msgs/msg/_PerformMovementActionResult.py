...
"""autogenerated by genpy from roboy_control_msgs/PerformMovementActionResult.msg. Do not edit."""
import codecs
import sys
...
class PerformMovementActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "roboy_control_msgs/PerformMovementActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','roboy_control_msgs/PerformMovementResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PerformMovementActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = roboy_control_msgs.msg.PerformMovementResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = roboy_control_msgs.msg.PerformMovementResult()
