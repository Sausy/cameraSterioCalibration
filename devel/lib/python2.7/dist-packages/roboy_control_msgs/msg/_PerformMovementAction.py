...
"""autogenerated by genpy from roboy_control_msgs/PerformMovementAction.msg. Do not edit."""
import codecs
import sys
...
class PerformMovementAction(genpy.Message):
  _md5sum = "3c4709f242209b87468a88e6c2263d39"
  _type = "roboy_control_msgs/PerformMovementAction"
...
"""
  ...
  _slot_types = ['roboy_control_msgs/PerformMovementActionGoal','roboy_control_msgs/PerformMovementActionResult','roboy_control_msgs/PerformMovementActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PerformMovementAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = roboy_control_msgs.msg.PerformMovementActionGoal()
      if self.action_result is None:
        self.action_result = roboy_control_msgs.msg.PerformMovementActionResult()
      if self.action_feedback is None:
        self.action_feedback = roboy_control_msgs.msg.PerformMovementActionFeedback()
    else:
      self.action_goal = roboy_control_msgs.msg.PerformMovementActionGoal()
      self.action_result = roboy_control_msgs.msg.PerformMovementActionResult()
      self.action_feedback = roboy_control_msgs.msg.PerformMovementActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.time_left
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.time_left,) = _get_struct_i().unpack(str[start:end])
      return self
